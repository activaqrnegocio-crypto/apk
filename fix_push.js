const fs = require('fs');
const path = 'd:/Abel paginas/Aquatech/crm mayo/aquatech-render-main/src/lib/push.ts';
const content = `import webpush from 'web-push'
...
console.log('push.ts written successfully');