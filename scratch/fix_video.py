...
with open('src/components/project/ProjectDetailBase.tsx', 'r', encoding='utf8') as f:
    content = f.read()
...
if count > 0:
    ...
    with open('src/components/project/ProjectDetailBase.tsx', 'w', encoding='utf8') as f:
        f.write(content)
